...
class SQLiteMineco:
    """Clase para gestionar la base de datos de indicadores en SQLite."""
    ...
    def extract_dataframes_from_zip_file(self, zip_path, output_dir="data/indicadores"):
        """Extrae CSV desde un archivo ZIP guardado y retorna una lista de DataFrames."""
...
if __name__ == "__main__":
    ...
    try:
        ...
        # La URL de ZIP (reemplazar con URL real)
        zip_url = "https://example.com/indicadores.zip"
        zip_file = db.download_zip_to_file(zip_url)

        if zip_file and db.extract_dataframes_from_zip_file(zip_file):
